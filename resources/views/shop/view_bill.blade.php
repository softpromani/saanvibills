                ...
                <div class="statbox widget box box-shadow">
                    ...
                    <table id="invoice-list" class="table dt-table-hover" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="checkbox-column"> {{ (($bill_data->currentPage()-1)*10)+($loop->index+1) }} </td>
                                            ...
                                            <td><span class="inv-amount">{{ $bill->currency->symbol.' '.$bill->total_price }}</span></td>
                                            ...
                                            <td>
                                                ...
                                                <a class="badge badge-light-success " href="{{ route('shop.invoice.view',Crypt::encrypt($bill->id)) }}"><svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" class="css-i6dzq1"><polyline points="6 9 6 2 18 2 18 9"></polyline><path d="M6 18H4a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-2"></path><rect x="6" y="14" width="12" height="8"></rect></svg></a>
                                                <a class="badge badge-light-danger  action-delete" href="javascript:void(0);"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-trash"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path></svg></a>
                                            </td>
                                        </tr>
                                ...
                                {!! $bill_data->links('pagination::bootstrap-5') !!}
                    </div>
